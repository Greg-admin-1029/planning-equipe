...
# ==========================================
# STYLE CSS (Léo) - Noms en blanc, colonnes carrées
# ==========================================
st.markdown("""
    <style>
    ...
    /* En-tête du tableau : Noms en blanc sur fond bleu foncé */
    thead tr th {
    ...
    /* Style des cellules pour un aspect plus compact/carré */
    .stDataFrame td {
